...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getQuote = __webpack_require__(1);
	...
	var quote = new _getQuote2.default();
	var tweet = new _share2.default();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Quote = function () {
	    function Quote() {
	        ...
	        this.newQuoteButton = (0, _jquery2.default)(".btn");
	        this.newQuote = (0, _jquery2.default)(".Quote__quote");
	        this.newAuthor = (0, _jquery2.default)(".Quote__author");
	        this.event();
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tweet = function () {
	    function Tweet() {
	        ...
	        this.tweetThis = (0, _jquery2.default)(".twitter-btn");
	        this.currentQuote = (0, _jquery2.default)(".Quote__quote");
	        this.currentAuthor = (0, _jquery2.default)(".Quote__author");
	        this.event();
	    }
	    ...
	    _createClass(Tweet, [{
	        ...
	        key: "shareThis",
	        value: function shareThis() {
	            window.open('https://twitter.com/intent/tweet?hashtags=quotes&related=freecodecamp&text=' + '"' + this.currentQuote.text() + '"' + "  - " + this.currentAuthor.text());
	        }
	    }]);
